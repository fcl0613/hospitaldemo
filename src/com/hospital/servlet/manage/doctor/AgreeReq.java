...
/**
 * Servlet implementation class AgreeReq
 */
@WebServlet("/manage/agreereq")
public class AgreeReq extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int res = scheduleServiceImpl.agreeReq(Integer.valueOf(idStr));
		if (res > 0) {
			out.write("<script>");
