...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="index.jsp">首页</a><span class="crumb-step">&gt;</span><span class="crumb-step">&gt;</span><span>更新医生信息</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="/hospital/manage/doupdatedoctor" method="post" id="myform" name="myform" enctype="multipart/form-data" onsubmit="return checkForm(this)">
                    <input type="hidden" name="did" value="${doctor.id }"/>
                    <input type="hidden" name="picture" value="${doctor.imagepath }"/>
                    <table class="insert-tab" width="100%">
                        <tbody>
                            <tr>
                                <th><i class="require-red"></i>医生账号:</th>
                                <td>
                                    <input class="common-text required" id="title" name="account" size="50" value="${doctor.account }" type="text" readonly="readonly">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="title" name="dname" size="50" value="${doctor.name}" type="text" onblur="checkItem(this)">
                                	<span class="error" id="err"></span>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <th>挂号费:</th>
                                <td><input class="common-text" name="fee" size="50" value="${doctor.fee }" type="text" onblur="checkItem(this)">
                                	<span class="error" id="err"></span>
                                </td>
                            </tr>
                           <tr>
                                <th>年龄:</th>
                                <td><input class="common-text" name="age" size="50" value="${doctor.age }" type="text" onblur="checkItem(this)">
                                	<span class="error" id="err"></span>
                                </td>
                            </tr>
                            <tr>
                                <th>描述:</th>
                                <td><input class="common-text" name="description" size="50" value="${doctor.description }" type="text" onblur="checkItem(this)">
                                	<span class="error" id="err"></span>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <th>更换图片:</th>
                                <td>
                                	<img width="80" height="80" alt="图片加载失败" src="../pic/${doctor.imagepath }">
